...
public class OrderData implements MultiItemEntity {
    ...
    public OrderData(String completeTime, String dispatchTime, String faultCd, String faultDesc, int faultId, String fixUser, int id, String img, String reportUser, String responseTime, String state) {
        this.completeTime = completeTime;
        this.dispatchTime = dispatchTime;
